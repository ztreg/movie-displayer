...
const MovieCard = ({ movie }: MovieProps) => {
  ...
  return (
    <Link href={`/movies/${movie.id}`}>
      <div className="car-card group text-blue-500 hover:underline">
        <div className="car-card__content">
          <h2 className="car-card__content-title justify-center">
            {movie.title}
          </h2> 
        </div>
        <div className="relative w-full h-96 my-3 object-contain scale-90 hover:scale-105 ease-in duration-100">
          <Image
